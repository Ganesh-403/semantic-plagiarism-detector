...
def startup_event() -> None:
    """Initialize persistent storage and validate configuration before serving."""
...
from src.api.routers.batch_history import router as batch_history_router
app.include_router(batch_history_router)
from src.api.routers.document_versions import router as document_versions_router
app.include_router(document_versions_router)
from src.api.routers.health_score import router as health_score_router
app.include_router(health_score_router)
from src.api.routers.heatmap import router as heatmap_router
