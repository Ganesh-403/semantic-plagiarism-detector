...
class SSRFProtector:
    ...
    def _check_redirect_depth(cls, url: str, max_redirects: int = 3) -> None:
        ...
        while True:
            ...
            response = requests.head(current_url, allow_redirects=False, timeout=5, headers=headers)
 ...
 feat/ssrf-user-agent
    ...
    def pinned_request(
        ...
        **kwargs,
        ...
        headers.setdefault("User-Agent", cls.DEFAULT_USER_AGENT)
