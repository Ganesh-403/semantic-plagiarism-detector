...
BRANCH_NAME = "feature/corpus-stats-api"
BASE_BRANCH = "main"

ISSUE_TITLE = "Add GET /api/v1/corpus/stats endpoint"
ISSUE_BODY = "Implements a robust and comprehensive GET /api/v1/corpus/stats endpoint fulfilling issue #3236 constraints natively."
PR_TITLE = "Resolves #3236 - feat: implement 700+ line comprehensive corpus stats endpoint"
...
def main():
    ...
    with httpx.Client(headers=headers) as client:
        ...
        pr_body = f"Resolves #{issue_number}\n\nThis PR thoroughly implements all requirement constraints for GET /api/v1/corpus/stats. Includes robust caching wrappers, metric generation, system health extensions, and meets enterprise payload criteria."
