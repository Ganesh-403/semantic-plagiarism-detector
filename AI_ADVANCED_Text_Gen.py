...
# Demo function
def demo_ai_detection_system(sustainability, skill_manager, plagiarism_system):
...
if __name__ == "__main__":
    raise SystemExit("This integration demo requires injected sustainability and skill-wallet services. Run streamlit run app/streamlit_app.py for the standalone application.")
