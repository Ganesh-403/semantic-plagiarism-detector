...
import pytest
from src.utils.pdf_highlighter import get_word_ngrams
...
def test_get_word_ngrams():
    ...
    assert ngrams[-1] == "that has more than six words"
...
def test_pdf_highlighter_ngrams():
    ...
    res = highlight_hl(pdf_bytes, [phrase])
...
def test_pdf_highlighters_context_manager():
    ...
    # Test pdf_highlighter.highlight_pdf_matches
