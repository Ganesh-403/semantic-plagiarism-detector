...
- **Check Memory Usage Details**:
  ...
  _Key metric to monitor:_ `used_memory_human` (actual data size) and `used_memory_peak_human` (highest memory usage recorded).
...
- **Check Fragmentation Ratio**:
  ...
  _Key metric to monitor:_ `mem_fragmentation_ratio`.
